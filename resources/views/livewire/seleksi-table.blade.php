                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-4 text-sm font-medium whitespace-nowrap">
                                        <a href="https://ppdb.smkplusalfarhan.sch.id/seleksi/206/wawancara" class="inline-flex items-center px-4 py-1 text-xs font-semibold leading-5 text-white bg-green-600 rounded-md">
                                            <span>TPA</span>
                                        </a>
                                    </td>
                                    <td class="px-2 py-4 text-sm font-medium whitespace-nowrap">
