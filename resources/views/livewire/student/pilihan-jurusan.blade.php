<x-jet-form-section submit="update">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-select wire:model="state.pilihan_kelas" id="state.pilihan_kelas" name="state.pilihan_kelas" autocomplete="state.pilihan_kelas" class="block w-full px-3 mt-1" required>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-select wire:model="state.pilihan_satu" id="state.pilihan_satu" name="state.pilihan_satu" autocomplete="state.pilihan_satu" class="block w-full px-3 mt-1" required>
                <option value="">{{ __('-- Pilih salah-satu') }}</option>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-select wire:model="state.pilihan_dua" id="state.pilihan_dua" name="state.pilihan_dua" autocomplete="state.pilihan_dua" class="block w-full px-3 mt-1" required>
                <option value="">{{ __('-- Pilih salah-satu') }}</option>
                <option value="1">Multimedia</option>
                <option value="2">Bisnis Daring dan Pemasaran</option>
                <option value="3">Agribisnis Pengolahan Hasil Pertanian</option>
